...
private final Color baseColor = new Color("aaaaaa");
	private final Color outerWallColor = new Color("aaaaaa");
	private final Color innerWallColor = new Color("777777");
	private final Color cornerColor = new Color("cccccc");
	private final Color holeColor = new Color("ffffff");
